...
//
// Detailed usage document and tutorial available on the go-zsmart Wiki page:
// https://github.com/zsmartex/go-zsmart/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
